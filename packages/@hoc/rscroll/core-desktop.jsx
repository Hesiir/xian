...
class Scroller extends Component {
  constructor(props) {
    ...
    this.translateZ = this.props.HWCompositing && utils.hasPerspective ? ' translateZ(0)' : ''
    ...
    this.disablePointer = this.props.disablePointer,
      this.disableTouch = this.props.disableTouch,
      this.disableMouse = this.props.disableMouse,
  ...
  _initScroll = () => {
    ...
    if (!this.useTransition) {
      if (!(/relative|absolute/i).test(this.refs.scroller.style.position)) {
        this.refs.scroller.style.position = "relative"
      }
    }
  ...
  initEvents(remove) {
    ...
    if (this.props.onScroll) this.on('scroll', this.props.onScroll.bind(null, this))
  }
  ...
  _execEvent(type) {
    ...
    for (; i < l; i++) {
    console.log('execevent', this._events[type])
